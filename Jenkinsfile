	...
	stage('Requerimientos') {
        ...
        stage('TestApp') {
            steps {
                ...
                sh "python3 Pruebas/prueba1.py && python3 Pruebas/prueba2.py && python3 Pruebas/prueba3.py && python3 Pruebas/prueba4.py && python3 Pruebas/prueba5.py && python3 Pruebas/prueba6.py && python3 Pruebas/prueba7.py && python3 Pruebas/prueba8.py && python3 Pruebas/prueba9.py"   
            }
        }  
