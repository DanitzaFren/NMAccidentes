...
#rver solicitar_Servicios_Asesoria
    def test_solicitar_Servicios_Asesoria_cliente(self):
        driver = self.driver
        ...
        if driver.find_element_by_xpath("/html/body/main/section[2]/div/div/div[1]").text=='Solicitud: agregado':
            print("Se solicito una nueva Asesoria ")
        else:
            print("no solicito asesoria")
