...
#rver solicitar_Servicios_Capacitación 
    def test_solicitar_Servicios_Capacitación_cliente(self):
        driver = self.driver
        ...
        if driver.find_element_by_xpath("/html/body/main/section[2]/div/div/div[1]").text=='Solicitud: agregado':
            print("Se solicito una nueva Capacitación  ")
        else:
            print("no solicito Capacitación ")
